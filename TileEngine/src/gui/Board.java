...
//	}
	...
	// if (key == KeyEvent.VK_LEFT && !player.isKeyLeft()) {
	// player.setPlayerDX(-1);
	// player.setKeyLeft(true);
	// player.setLastDir(1);
	// }
	// if (key == KeyEvent.VK_RIGHT && !player.isKeyRight()) {
	// player.setPlayerDX(1);
	// player.setKeyRight(true);
	// player.setLastDir(2);
	// }
	// if (key == KeyEvent.VK_UP && !player.isKeyUp()) {
	// //playerdy = -1;
	// //Check if the player is grounded or airbourne.
	// if (!player.isAirborne(map.getLevelData())) {
	// player.setKeyUp(true);
	// }
	// //lastDir = 3;
	// }
	// if (key == KeyEvent.VK_DOWN && !player.isKeyDown()) {
	// //playerdy = 1;
	// player.setKeyDown(true);
	// //lastDir = 4;
	// }
	// if (key == KeyEvent.VK_SPACE) {
	// player.placeBlock(map.getLevelData(), map.getBlockData());
	// }
	// }
	//
	// public void keyReleased(KeyEvent e) {
	...
	// //playerdy = 0;
	// //keyUp = false; //we want to automatically control the jump, not
	// manually.
	// }
